...
U = m.Param(value=2.68238)
tau=m.Param(value=19.619)
a1=m.Param(value=0.00988)
a2=m.Param(0.0060424)
...
Ta = m.Param(value=T_surr+273.15) # degC
...
try:
    for i in range(1,n):
        ...
        plt.plot(tm[i]+m.time,results['tc1.tr_hi'],'k--',label=r'$T_1$ Traj')
        ...
        plt.plot(tm[i]+m.time,results['tc2.tr_hi'],'k--',label=r'$T_2$ Traj')
